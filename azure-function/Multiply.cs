...
namespace MathPlugin
{
    public class Multiply
    {
        ...
        [Function("Multiply")]
        [OpenApiOperation(operationId: "Multiply", tags: new[] { "ExecuteFunction" }, Description = "Multiplys two numbers.")]
        ...
        public HttpResponseData Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequestData req)
        {
            ...
            if (result1 && result2)
            {
                ...
                _logger.LogInformation($"Multiply function processed a request. Sum: {sum}");
